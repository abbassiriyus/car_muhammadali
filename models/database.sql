...
INSERT INTO car (
  ...
  subcategory, category, power_windows, air_conditioning, power_brakes, 
  ...
  (
    ...
    'Black', 'Silver', 'Automatic', 50000, 'New York',
    (SELECT id FROM subcategory WHERE title = 'Toyota Camry' AND category_id = (SELECT id FROM category WHERE title = 'Toyota')),
    (SELECT id FROM category WHERE title = 'Toyota'),
    true, true, true, 'Excellent', 'New York, NY', 'This is a high-quality Toyota Camry with low mileage.'
  ),
  (
    'Honda Civic', 'https://i.pinimg.com/736x/a4/a5/4d/a4a54d8f5b1c09f597253982c076bf42.jpg', 30, 'DEF456', 22000, 2018, 'Honda', 'Civic',
    'Beige', 'Gray', 'Manual', 70000, 'California',
    (SELECT id FROM subcategory WHERE title = 'Honda Civic' AND category_id = (SELECT id FROM category WHERE title = 'Honda')),
    (SELECT id FROM category WHERE title = 'Honda'),
  ...
  (
    ...
    (SELECT id FROM subcategory WHERE title = 'Ford Mustang' AND category_id = (SELECT id FROM category WHERE title = 'Ford')),
    (SELECT id FROM category WHERE title = 'Ford'),
  ...
  (
    ...
    (SELECT id FROM subcategory WHERE title = 'Volkswagen Golf' AND category_id = (SELECT id FROM category WHERE title = 'Volkswagen')),
    (SELECT id FROM category WHERE title = 'Volkswagen'),
  ...
  (
    ...
    (SELECT id FROM subcategory WHERE title = 'BMW 3 Series' AND category_id = (SELECT id FROM category WHERE title = 'BMW')),
    (SELECT id FROM category WHERE title = 'BMW'),
  ...
  (
    ...
    'Beige', 'Silver', 'Automatic', 30000, 'Georgia',
    (SELECT id FROM subcategory WHERE title = 'Mercedes-Benz C-Class' AND category_id = (SELECT id FROM category WHERE title = 'Mercedes-Benz')),
    (SELECT id FROM category WHERE title = 'Mercedes-Benz'),
  ...
  (
    ...
    'Black', 'Gray', 'Automatic', 60000, 'Washington',
    (SELECT id FROM subcategory WHERE title = 'Audi A4' AND category_id = (SELECT id FROM category WHERE title = 'Audi')),
    (SELECT id FROM category WHERE title = 'Audi'),
  ...
  (
    ...
    (SELECT id FROM subcategory WHERE title = 'Nissan Altima' AND category_id = (SELECT id FROM category WHERE title = 'Nissan')),
    (SELECT id FROM category WHERE title = 'Nissan'),
  ...
  (
    ...
    (SELECT id FROM subcategory WHERE title = 'Chevrolet Silverado' AND category_id = (SELECT id FROM category WHERE title = 'Chevrolet')),
    (SELECT id FROM category WHERE title = 'Chevrolet'),
  ...
  (
    ...
    (SELECT id FROM subcategory WHERE title = 'Hyundai Sonata' AND category_id = (SELECT id FROM category WHERE title = 'Hyundai')),
    (SELECT id FROM category WHERE title = 'Hyundai'),
